...
import {deletestudent,fetchstudent,updatestudent} from "../../../../../services/students/students"
        ...
        <View className="bg-white flex-1">
          <View className="flex flex-col ">
            ...
            <View className="flex flex-col w-full items-center justify-center gap-4 mt-5">
              ...
              <TextInput onChangeText={setid} value={id}  className="border-purple-500 border rounded-md w-2/3" />
